...
public class DappBrowserUtilsTest
{
    ...
    {
        assertThat(DappBrowserUtils.defaultDapp(1L), equalTo(" https://www.nbblocks.cc/"));
    ...
    {
        assertTrue(DappBrowserUtils.isDefaultDapp(" https://www.nbblocks.cc/"));
    ...
    public void testIsWithinHomePage()
    {
        ...
        assertTrue(DappBrowserUtils.isWithinHomePage(" https://www.nbblocks.cc/"));
        assertTrue(DappBrowserUtils.isWithinHomePage(" https://www.nbblocks.cc/xxx"));
