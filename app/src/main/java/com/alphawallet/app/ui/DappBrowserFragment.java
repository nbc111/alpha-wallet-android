        ...
        ActionSheetCallback, TestNetDialog.TestNetDialogCallback
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ...
        if (getArguments() != null && getArguments().getString("url") != null)
        {
            ...
            Log.e(TAG, "onCreateView: 获取到的Url地址 1：" + loadOnInit + "   " + Log.getStackTraceString(new Throwable()));
        }
...
//            toolbar.getMenu().findItem(R.id.action_network).setTitle(getString(R.string.network_menu_item, activeNetwork.getShortName()));
            toolbar.getMenu().findItem(R.id.action_network).setTitle(getString(R.string.network_menu_item, "NBC"));
//            symbol.setText(activeNetwork.getShortName());
    ...
    private void initView(@NotNull View view)
    {
        ...
        if (savedState != null)
        {
            ...
            Log.e(TAG, "onCreateView: 获取到的Url地址 2：" + loadOnInit + "   " + Log.getStackTraceString(new Throwable()));
        }
        else
        {
            loadOnInit = getDefaultDappUrl();
            Log.e(TAG, "onCreateView: 获取到的Url地址 3：" + loadOnInit + "   " + Log.getStackTraceString(new Throwable()));
        }
...
//        Log.e(TAG, "setupWeb3: 浏览器地址：" + wallet.address + "   " + Log.getStackTraceString(new Throwable()));
    ...
    {
//        Log.e(TAG, "loadUrl: 加载Url：" + urlText + "   " + Log.getStackTraceString(new Throwable()));
        requireContext();
