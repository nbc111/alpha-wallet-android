...
public abstract class C {
    ...
    public static final String NBC_NETWORK_NAME = "NBCoin (NBC)";
    ...
    public static final String NBC_SYMBOL = "NBC";
    ...
    public static final String DEFAULT_NETWORK = NBC_NETWORK_NAME;
