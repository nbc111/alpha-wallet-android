...
{ // implements EthereumNetworkRepositoryType
    ...
    public static final long CUSTOM_NETWORK_ID = 1001; // Using a custom chain ID that's typically used for testnets
    ...
    {
        {
            ...
            put(CUSTOM_NETWORK_ID, new NetworkInfo("zkb Network", "ZCB", CUSTOM_RPC_URL, "",
